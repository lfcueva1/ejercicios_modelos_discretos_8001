...
def leer_variables():
    ...
    print("Ingrese el valor de la base del paralelogramo: ",end="")
    ...
    print("Ingrese el valor de la altura del paralelogramo: ",end="")
...
def calcular_area_paralelogramo(base,altura):
    '''
    Funcion que calcula el area de un paralelogramo
    ...
    ------------
        area : float
    '''
    #calculamos area del paralelogramo
    area= base*altura
    #retornamos el area
    return area
if __name__ == '__main__':
    ...
    print("El area del paralelogramo es: ",calcular_area_paralelogramo(base,altura))